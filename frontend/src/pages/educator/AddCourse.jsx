...
import { addNewCourse } from "../../utilityFunctions/apiCalls";
...
const AddCourse = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    await addNewCourse({ image, courseData, token }).then((res) => {
      setAdding(false);
      if (res) {
        setAdding(false);
        setCourseTitle("");
        ...
        console.log("Error while adding the course");
      }
    });
    ...
    <div className="min-h-[90vh] overflow-scroll flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0">
      ...
      >
            ...
            <div className="fixed inset-0 flex items-center justify-center bg-gray-800/70">
              <div className="bg-white text-gray-700 p-4 rounded relative w-full max-w-80">
                ...
                <div className="flex flex-row-reverse justify-end gap-1 my-2 items-center pl-1">
                  <label htmlFor="isPreview" className="mt-0.5">
                    Is Preview Free?
                  </label>
                  <input
                    type="checkbox"
                ...
                <button
                  onClick={addLecture}
                  type="button"
                  className="w-full bg-blue-400 cursor-pointer hover:bg-blue-500 transition-all duration-200 text-white px-4 py-2 rounded"
                >
                  Add
                </button>
        ...
        <button
          ...
          disabled={adding}
          className={`relative font-semibold text-lg text-white w-26 py-2.5 px-8 rounded my-4 transition-all duration-200 ${
            adding
        ...
        >
          {adding ? (
            <div className="w-full flex justify-center items-center">
              <div className="w-7 aspect-square border-4 border-white border-t-4 border-t-blue-400 rounded-full animate-spin"></div>
            </div>
          ) : (
            "ADD"
          )}
